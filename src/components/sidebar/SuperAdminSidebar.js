          ...
          <NavLink key={item.to} to={item.to}>
            {({ isActive }) => (
              <div
                ...
                } py-3 rounded-xl transition-all duration-300 ease-in-out hover:scale-105 hover:shadow-lg ${
                  isActive
              ...
              >
                ...
                <div
                  className={`absolute right-0 top-1/2 -translate-y-1/2 w-1 h-6 bg-gradient-to-b from-emerald-400 to-teal-400 rounded-l-full transition-all duration-300 ${
