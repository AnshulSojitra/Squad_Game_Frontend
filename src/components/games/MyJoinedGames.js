...
import { getMyJoinedGames, getUserProfile } from "../../services/api";
  ...
  if (!games.length) {
    return (
      <div className="flex flex-col items-center justify-center py-14 rounded-xl border border-slate-800 bg-slate-900/40">
        ...
        <h3 className="text-xl font-semibold text-white mb-2">No Joined Games</h3>
