...
export default function AdminLogin() {
  ...
  <div className="h-screen bg-gray-900 flex flex-col">
    ...
    {/* MAIN */}
    <main className="flex-1 bg-gradient-to-br from-gray-900 via-black to-gray-900 flex items-center justify-center px-4 animate-fade-in">

      {/* LOGIN CARD */}
      <div className="w-full max-w-md bg-gray-900/90 backdrop-blur-lg border border-gray-700 rounded-3xl shadow-2xl p-8 text-white">
        {/* Header */}
        <div className="text-center mb-8">
          <h2 className="text-3xl font-bold mb-2 bg-gradient-to-r from-indigo-400 to-purple-400 bg-clip-text text-transparent">
            Admin Login
          ...
          <div>
            ...
            <div className="relative">
              <input
                ...
                onChange={handleChange}
                placeholder="••••••••"
                className={`w-full px-4 py-2 border rounded-lg focus:outline-none text-black pr-12 ${
