        ...
        <div className="px-4 sm:px-6 py-4 border-b border-slate-700 flex flex-col gap-3 md:flex-row md:items-center md:justify-between">
          ...
          <div className="relative w-full md:w-auto">
            ...
            <input
              ...
              className="w-full min-w-0 pl-10 pr-4 py-2 bg-slate-700 border border-slate-600 rounded-lg text-sm text-white placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent md:w-80"
            />
          </div>
          ...
          <select
            ...
            className="w-full md:w-auto px-4 py-2 bg-slate-700 border border-slate-600 rounded-lg text-sm text-white focus:outline-none focus:ring-2 focus:ring-blue-500"
          >
              ...
              {paginatedGrounds.map((ground) => (
                ...
                >
                  ...
                  <div className="relative h-48 bg-slate-600 overflow-hidden">
                    <img
                      src={ground.images?.[0] ? `${ground.images[0].imageUrl}` : "/placeholder.png"}
                      alt={ground.name}
